...
// For e.g. numbers, texts, symbols, etc.
 ...
 void main() {
 // Declaring Variables  
int number1 = 100; // without decimal .
double number2 = 130.2; // with decimal .
num number3 = 50;
num  number4 = 50.4;  
...
// Printing Info   
print("Num 1 is $number1");
print("Num 2 is $number2");  
print("Num 3 is $number3");  
print("Num 4 is $number4");  
print("Sum is $sum");  
